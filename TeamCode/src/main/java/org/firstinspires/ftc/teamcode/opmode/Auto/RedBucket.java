...
//                new ParallelAction(
//                    new TrajectoryCommand(new setDepositScoring(robot.deposit, HIGH_SPECIMEN_HEIGHT, Deposit.DepositPivotState.SPECIMEN_SCORING)),
//                    moveToSpecimen
//                ),
//                new ParallelAction(
//                    new TrajectoryCommand(new depositSafeRetracted(robot.deposit)),
//                    moveBack
//                ),
//                pushSamples,
//                new ParallelAction(
